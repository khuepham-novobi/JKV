...
class ProductCategorySlider(models.Model):
    _name = 'furnito.product.slider.config'
    ...
    collections_product = fields.Many2many('product.template', 'furnito_theme_product_slider_rel', 'slider_id',
                                           'prod_id', string="Collections of product", required=True)


class BlogSlider(models.Model):

    _name = 'furnito.blog.slider.config'
...
class MultiSlider(models.Model):
    _name = 'furnito.multi.slider.config'
...
class CategorySlider(models.Model):
    _name = 'furnito.category.slider.config'
    ...
    sliding_speed = fields.Integer(string="Slider sliding speed", default='5000',
                                   help='Sliding speed of a slider can be set from here and it will be in milliseconds.')
    collections_category = fields.Many2many('product.public.category', 'theme_furnito_category_slider_rel',
                                            'slider_id', 'cat_id', string="Collections of category")


class FeatureProductSlider(models.Model):
    _name = 'furnito.feature.product.slider.config'
    ...
    feature_products_collections = fields.Many2many('product.template', 'theme_furnito_feature_products_collections_slider_rel',
    ...
    on_sale_collections = fields.Many2many('product.template', 'theme_furnito_on_sale_name_collections_slider_rel',
                                           'slider_id', 'prod_id', required=True, string="Products Collections")
    ...
    random_products_collections = fields.Many2many('product.template', 'theme_furnito_random_products_collections_slider_rel',
                                                   'slider_id', 'prod_id', required=True, string="Products Collections")
    ...
    low_price_collections = fields.Many2many('product.template', 'theme_furnito_low_price_products_collections_slider_rel',
                                             'slider_id', 'prod_id', required=True, string="Products Collections")
