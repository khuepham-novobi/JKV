odoo.define('theme_furnito.theme_furnito_js', function(require) {
    'use strict';
    ...
    $(document).ready(function() {
            ...
            $(oe_website_sale).on("change", ".oe_cart input.js_quantity[data-product-id]", function() {
                ...
                clickwatch(function() {
                    ...
                    ajax.jsonRpc("/shop/cart/update_json", 'call', {
                        ...
                        var $q1 = $(".furnito_theme_cart_quantity");
                        $q1.html(data.cart_quantity).hide().fadeIn(600);
                        $("#furnito_hover_total").replaceWith(data['theme_furnito.hover_total']);
                    });
                }, 500);
        ...
        // Multi image gallery
        ajax.jsonRpc('/theme_furnito/multi_image_effect_config', 'call', {})
            .done(function(res) {
                var dynamic_data = {}
        ...
        var minval = $("input#m1").attr('value'),
            ...
            website_currency = $('input#furnito_theme_website_currency').attr('value');
        ...
        $("a#clear").on('click', function() {
            ...
            ajax.jsonRpc("/theme_furnito/removeattribute", 'call', {
                'attr_remove': lival
            }).then(function(data) {
                if (data == true) {
