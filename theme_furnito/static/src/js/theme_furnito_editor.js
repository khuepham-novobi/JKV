odoo.define('theme_furnito.theme_furnito_editor_js', function(require) {
    'use strict';
    ...
    ajax.loadXML('/theme_furnito/static/src/xml/theme_furnito.xml', qweb);

    options.registry.theme_furnito_product_category_slider = options.Class.extend({
        ...
        pro_cat_slider: function(type, value) {
            ...
            if (type == "click" || type == undefined) {
                self.$modal = $(qweb.render("theme_furnito.furnito_theme_dynamic_product_category_slider"));
                ...
                ajax.jsonRpc('/theme_furnito/pro_get_options', 'call', {}).done(function(res) {
    ...
    options.registry.theme_furnito_brand_custom_slider = options.Class.extend({

        start: function(editMode) {
            var self = this;
            this._super();
            this.$target.removeClass("hidden");
            this.$target.find(".furnito_theme_brand_slider .owl-carousel").empty();
            if (!editMode) {
                self.$el.find(".furnito_theme_brand_slider").on("click", _.bind(self.furnito_brand_slider, self));
            }
        },
        ...
        drop_and_build_snippet: function() {
            var self = this;
            this._super();
            if (this.furnito_brand_slider()) {
                this.furnito_brand_slider().fail(function() {
                    self.editor.on_remove();
                });
            }
        },
        ...
        clean_for_save: function() {
            $('.furnito_theme_brand_slider .owl-carousel').empty();
        },

        furnito_brand_slider: function(type, value) {
            var self = this;
            if (type == "click" || type == undefined) {
                self.$modal = $(qweb.render("theme_furnito.furnito_theme_brands_slider_block"));
                self.$modal.appendTo('body');
                self.$modal.modal();
    ...
    options.registry.theme_furnito_blog_custom_snippet = options.Class.extend({

        start: function(editMode) {
            var self = this;
            this._super();
            this.$target.removeClass("hidden");
            this.$target.find('.furnito_theme_blog_slider .owl-carousel').empty();
            if (!editMode) {
                self.$el.find(".furnito_theme_blog_slider").on("click", _.bind(self.king_blog_slider, self));
            }
        },
        ...
        king_blog_slider: function(type, value) {
            var self = this;
            if (type == "click" || type == undefined) {
                self.$modal = $(qweb.render("theme_furnito.furnito_theme_blog_slider_block"));
                self.$modal.appendTo('body');
                self.$modal.modal();
                ...
                ajax.jsonRpc('/theme_furnito/blog_get_options', 'call', {}).done(function(res) {
    ...
    options.registry.theme_furnito_multi_cat_custom_snippet = options.Class.extend({
        ...
        multi_category_slider: function(type, value) {
            var self = this;
            if (type == "click" || type == undefined) {
                self.$modal = $(qweb.render("theme_furnito.multi_product_custom_slider_block"));
                self.$modal.appendTo('body');
                self.$modal.modal();
                var $slider_type = self.$modal.find("#slider_type"),
                    $cancel = self.$modal.find("#cancel"),
                ...
                ajax.jsonRpc('/theme_furnito/product_multi_get_options', 'call', {}).done(function(res) {
    ...
    options.registry.theme_furnito_category_slider = options.Class.extend({
        start: function(editMode) {
            var self = this;
            this._super();
            this.$target.removeClass("hidden");
        ...
        cat_slider: function(type, value) {
            var self = this;
            if (type == "click" || type == undefined) {
                self.$modal = $(qweb.render("theme_furnito.crafito_dynamic_category_slider"));
                self.$modal.appendTo('body');
                self.$modal.modal();
                var $slider_type = self.$modal.find("#slider_type"),
                ...
                ajax.jsonRpc('/theme_furnito/category_get_options', 'call', {}).done(function(res) {
                    $('#slider_type option[value!="0"]').remove();
                    _.each(res, function(y) {
                        $("select[id='slider_type'").append($('<option>', {
                            value: y["id"],
    ...
    options.registry.theme_furnito_featured_product_slider = options.Class.extend({
        start: function(editMode) {
            var self = this;
            this._super();
            this.$target.removeClass("hidden");
        ...
        featured_prod_slider: function(type, value) {
            var self = this;
            if (type == "click" || type == undefined) {
                self.$modal = $(qweb.render("theme_furnito.furnito_dynamic_featured_product_slider"));
                self.$modal.appendTo('body');
                self.$modal.modal();
                ...
                ajax.jsonRpc('/theme_furnito/featured_product_get_options', 'call', {}).done(function(res) {
                    $('#slider_type option[value!="0"]').remove();
                    _.each(res, function(y) {
